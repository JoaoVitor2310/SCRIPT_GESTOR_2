        ...
        <div class="">
            ...
            <div style="padding: 10px;-webkit-box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);width: 99%;" class="row card">
                <div class="col-md-12">
                    ...
                    <small>Apenas 500 carecteres | <a href="https://gestormaster.top/painel/termo_comunidade" target="_blank"><i class="fa fa-file"></i> Regras da comunidade</a></small>
                </div>
                ...
                ?>
                    ...
                    <div style="border-bottom: 1px solid #d500ff;margin: 10px;padding-bottom: 12px;width: 99%;" class="post col-md-12">
                        <div class="row">
                            ...
                            <div  class="col-md-11">
                                <span style="font-size: 19px;"> <?= $autor->nome; ?> <?php if($autor->id == '156'){ echo '<img style="top: 6px!important;position: absolute;margin-left: 7px;" src="https://'.$gestor_class->get_options("dominio").'/painel/img/verificado_comunidade.png" width="20" />'; } ?></span>
