 ...
 <div class="modal-dialog" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body" id="body_modal_del_mov" >
       ...
       <h4>Você realmente deseja deletar essa movimentação?</h4>
     </div>
...
<div class="modal fade" id="modal_import" tabindex="-1" role="dialog" aria-labelledby="TituloModalLongoExemplo" aria-hidden="true">
 <div class="modal-dialog" role="document">
   <div class="modal-content">
     <div class="modal-header">
       <h5 class="modal-title" id="titutlo_modal_del_mov">Importar dados</h5>
       <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>
     <div class="modal-body" id="body_import" >
        <form id="form_import" method="POST" action="https://gestormaster.top/control/import-xlsx/" enctype="multipart/form-data" >
               <div class="form-group">
                    <select hidden name="type_import" class="form-control" >
                        <!-- <option>Selecione a plataforma</option> -->
                        <option  value="zeropaper" selected >ZeroPaper</option>
                    </select>
                </div>
                 <div class="form-group">
                   <h6> Importe arquivos <b>.xlsx</b> </h6>
