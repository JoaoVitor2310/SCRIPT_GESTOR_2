      ...
      <div class="col-md-12">
       <div class="row">
              <div class="col-md-6">
                   ...
                   <span style="font-size:10px;" >Integre seu painel gestormaster.top para gerar teste automáticos.</span>
              </div>
              <div class="col-md-6">
                  <div class="btn-group">
                    ...
                    <table class="table table-striped table-sm">
                      ...
                      <tbody id="tbody_" class="" >
                        ...
                        <tr >
                          ...
                          <td><?= $teste; ?></td>
                          <td><a href="https://gestormaster.top/gmaster/t/<?= $painel->chave; ?>" target="_blank" >https://gestormaster.top/gmaster/t/<?php echo substr($painel->chave,0,6); ?>...</td>
                          <td>
                        ...
                        <textarea style="display:none;" id="ifram_cod_<?= $painel->id; ?>" ><iframe src="https://gestormaster.top/gmaster/t/<?= $painel->chave; ?>" style="height:100%;width:100%;border:none;" name="Gerador de testes" ></iframe></textarea>
                ...
                <div class="row" >
                    ...
                    <div class="form-group col-md-6" >
                        <label>Painel</label>
                         ...
                         <small>Quer sugerir outro painel para que possamos criar uma integração ? <a target="_blank" href="https://gestormaster.top/faq?wpp&text=Eu gostaria de sugerir um outro painel para integrar ao ggestormaster.top." >Clique aqui</a></small>
                    </div>
                </div>
...
<script typ="text/javascript" src="https://gestormaster.top/painel/js/xtream_ui.js" ></script>
