        ...
        <table class="table table-bordered table-striped table-sm">
          ...
          <tbody id="" class="" >
            ...
            <tr class="" >
              ...
              <td><?= $link->slug; ?></td>
              <td><?= $link->cliques; ?></td>
              <td><a onclick="copyToClipboard(<?= $link->id; ?>);" style="cursor:pointer;" class="text-info" >https://linkzap.gestormaster.top/<?= $link->slug; ?></a> <i id="icon_copy_<?= $link->id; ?>" onclick="copyToClipboard(<?= $link->id; ?>);" style="cursor:pointer;" class="fa fa-copy"></i>
              <small id="info_copy_<?= $link->id; ?>" style="font-size:10px;display:none;" class="text-success">Copiado</small>
              </td>
              <input type="hidden" value="https://linkzap.gestormaster.top/<?= $link->slug; ?>" id="linkzap_<?= $link->id; ?>" />
              <td>
          ...
          <div class="row">
           ...
           <div class="col-md-12">
             ...
             <div class="input-group-append">
                <span class="input-group-text" id="basic-addon2">https://linkzap.gestormaster.top/</span>
              </div>
