...
<main class="page-content">
  ...
  <div class="">
    ...
    <div
      ...
      <div class="col-md-6">
        <h1 class="h2 h2-cell">WhatsAPI <i class="fa fa-whatsapp"></i></h1>
      ...
      <div style="margin-bottom:10px;" class="col-md-12">
        <div class="btn-toolbar ">
          <div class="btn-group mr-12">
            <button onclick="location.href='fila_zap';" class="btn btn-outline-secondary">Acompanhar fila <span
                class="badge badge-info">new</span></button>
            <button onclick="$('#modal_pareamento_zapi').modal('show');" class="btn btn-outline-secondary"><i
                class="fa fa-whatsapp"></i> Conectar / Desconetar Whatsapp</button>
            <!-- <button onclick="$('#modal_pareamento').modal('show');" class="btn btn-outline-secondary"><i
                class="fa fa-key"></i> Configurar Credenciais</button> -->
          ...
          <table class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <th>
                  <?= $idioma->data; ?> <i class="fa fa-calendar"></i>
                </th>
                <th>
                  <?= $idioma->mensagem; ?> <i class="fa fa-comments"></i>
                </th>
              </tr>
            </thead>
              ...
              if ($wsapi) {
                ...
                while ($msg = $wsapi->fetch(PDO::FETCH_OBJ)) {
                  ...
                  <tr>
                    ...
                    <td style="width:70%;"><i class="fa fa-arrow-right"></i>
                      <?= $msg->msg; ?>
                    </td>
...
<!--  Modal  gestorBot -->
<div class="modal fade" data-backdrop="static" id="modal_gestorBot" tabindex="-1" role="dialog"
  aria-labelledby="Titutlo_modal_gestorBot" aria-hidden="true">
      ...
      <div class="modal-body " id="body_modal_gestorBot">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <fieldset
              style="padding-top:10px!important;border: 1px solid #CCC;margin:5px;padding:5px;border-radius:10px;"
              class="row col-md-12">

              <div class="col-md-6 form-group">
                <div class="custom-control custom-checkbox mr-lg">
                  <input <?php if ($v_device_gestorbot) {
                    if ($v_device_gestorbot->situ == 1) {
                      echo 'checked';
                    }
                  } ?>
                    type="checkbox" class="custom-control-input" id="situ_api_gestorbot">
              ...
              <div class="col-md-12 form-group">
                <input style="cursor:no-drop;" type="text" value="<?= base64_encode($user->email); ?>" disabled
                  placeholder="API KEY" class="form-control" />
                <input type="text" value="<?= base64_encode($user->email); ?>" style="display:none;"
                  placeholder="API KEY" id="api_key_gestorbot" class="form-control" />
              </div>

              <div class="col-md-12 form-group">
                <button id="btn_save_key_gestorbot" style="width:100%;" class="btn btn-primary btn-lg"
                  onclick="save_key('gestorbot');">Salvar</button>
              </div>
              ...
              <div class="col-md-12">
                <div class="">
                  <ul>
                    ...
                    <li>
                      <p>
                        A api <b>Gestor-bot</b> é uma instância gratuita fornecida pela Gestor Master. As mensagens são
                        enviadas automáticamente se ativada.
                      </p>
                      <p>
                        <i class="fa fa-hand-o-right"></i> Nós temos um número próprio para o envio das mensagens. <b>+1
                          (510) 370-1932</b>. É importante se você usar está api, pedir que seus clientes adicione este
                        número em suas agendas.
                      </p>
                      <p>
                        <i class="fa fa-hand-o-right"></i> Nós não respondemos nenhum cliente por este whatsapp, se
                        algum cliente seu enviar uma mensagem irá receber a seguinte mensagem:
                      <div class="alert alert-secondary">
                        Olá. Que pena, infelizmente não posso te ajudar.

                        🤖 Sou um robô criado apenas para enviar notificações. Tente entrar em contato com seu provedor
                        de serviços por outro lugar.
                      ...
                      <p>
                        <i class="fa fa-hand-o-right"></i> Portanto coloque todas as informações necessárias na mensagem
                        que será enviada.
                      </p>
                      <p>
                        <i class="fa fa-hand-o-right"></i> Adicione você também este número, será por ele, que serão
                        enviadas seus lembretes do painel.
                      </p>
                      <p>
                        <i class="fa fa-warning text-warning"></i> Contrate o plano patrão e envie mensagens pelo seu
                        próprio whatsapp
                      </p>
                    </li>
                  </ul>
...
<!--  Modal Scan whatsapp 1(esse que foi usado pro admin) -->
<div class="modal fade" data-backdrop="static" id="modal_pareamento_zapi" tabindex="-1" role="dialog"
  aria-labelledby="Titutlo_modal_pareamento" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body " id="body_modal_pareamento_zapi">
        ...
        <input type="hidden" value="<?php if ($v_device_zapi) {
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <ul>
              <li>
                Após escanear o QR Code, aguarde o pareamento no seu celular, e assim que terminar, atualize a página.
              </li>
            </ul>
          </div>
          <?php if (!$v_device_zapi) { ?>
          <div class="col-md-6">
            ...
            <?php }else{ ?>
              <ul>
                <li>
                  Você já está conectado, se deseja gerar outro QR Code, clique em <strong>"Desativar API"</strong> logo acima.
                </li>
                <li>
                  <strong>Atenção:</strong> se você desconectou direto pelo seu celular, o sistema ainda acha que você está conectado, clique em "Desativar a API" e se conecte novamente.
                </li>
              </ul>
            <?php } ?>
          </div>
...
<!--  Modal Scan whatsapp 2 -->
<div class="modal fade" data-backdrop="static" id="modal_pareamento" tabindex="-1" role="dialog"
  aria-labelledby="Titutlo_modal_pareamento" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <div class="col-md-12">
            ...
            <fieldset
              ...
              <div class="col-md-3 form-group">
                <img
                  src="<?php if ($dark == 1) {
                    echo "https://panel.rapiwha.com/landing/images/logo_rapiwha-light.svg";
                  } else {
                    echo 'https://panel.rapiwha.com/landing/images/logo_rapiwha-dark.svg';
                  } ?>"
                  width="150" />
              </div>
              ...
              <div class="col-md-2 form-group">
                <div class="custom-control custom-checkbox mr-sm-2">
                  <input <?php if ($v_device_rapiwha) {
                    if ($v_device_rapiwha->situ == 1) {
                      echo 'checked';
                    }
                  } ?>
                    type="checkbox" class="custom-control-input" id="situ_api_rapiwha">
              ...
              <div class="col-md-12 form-group">
                <input type="text" value="<?php if ($v_device_rapiwha) {
                  echo $v_device_rapiwha->device_id;
                } ?>"
                  placeholder="API KEY" id="api_key_rapiwha" class="form-control" />
                <small>API KEY</small>
              </div>
              <div class="col-md-12 form-group">
                <button id="btn_save_key_rapiwha" style="width:100%;" class="btn btn-primary btn-lg"
                  onclick="save_key('rapiwha');">Salvar</button>
              </div>
