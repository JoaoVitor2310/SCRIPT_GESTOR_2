...
<script src="https://cdn.tiny.cloud/1/px13sohvwz1ybc8mxmg0m1ym4oyt4qvzf8s9dgml7994h1up/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
...
<script>
    ...
    function load_modelo_gateway(gate){
        $.get('https://gestormaster.top/painel/preview/modelo-gateway-'+ gate +'.txt',function(data){
