...
<main class="page-content">
  ...
  <div class="">
    ...
    <div
      ...
      <div class="col-md-12">
        <h1 class="h2 h2-cell">
          <?= $idioma->pagamentos; ?> <i class="fa fa-credit-card"></i>
        </h1>
      </div>
      <div class="col-md-12">
        <?php if ($user->id_rev == 0) { ?>
          <div class="col-md-6 h2-cell">
            <button onclick="location.href='cart';" type="button" class="btn btn-outline-success" name="button"><i
                    ...
                    while ($fatura = $list_faturas->fetch(PDO::FETCH_OBJ)) {
                      ...
                      if ($fatura->status == "Pendente") {
                        if (!is_file('../qrcodes/imgs/' . $fatura->id . '.png')) {
                          ...
                          QRcode::png('https://gestormaster.top/gmaster/c/' . $fatura->id, $filename, $errorCorrectionLevel, $matrixPointSize, 2);
                      ...
                      <tr>
                        <td title="<?= $idioma->o_identificador_e; ?> <?= $fatura->id; ?>">
                          <?= $fatura->id; ?>
                        </td>
                        <td title="<?= $idioma->valor_fat_e; ?> <?= $fatura->valor; ?> <?= $moedaN->nome; ?>">
                          <?= $moedaN->simbolo; ?>
                          <?= $fatura->valor; ?>
                        </td>
                        <td title="<?= $idioma->data_fat_e; ?> <?= $fatura->data; ?> às <?= $fatura->hora; ?>">
                          <?= $fatura->data; ?> -
                          <?= $fatura->hora; ?>
                        </td>
                        ...
                        <td title="<?= $idioma->form_pay_fat_e; ?>  <?= $fatura->forma; ?>">
                          ...
                          if ($fatura->forma === 'TED') {
                            ...
                            echo $icon_f . ' ' . $fatura->forma;
                          }
                          if ($fatura->comprovante != '0') {
                            echo '<a target="_blank" href="https://gestormaster.top/gmaster/comprovantes/' . $fatura->comprovante . '"><i class="fa fa-file"></i></a>';
                          }
                          echo $comp_link;
                          ?>
                        </td>
                        ...
                        <td title="<?= $idioma->status_fat_e; ?> <?= $fatura->status; ?>">
                          <?= $status; ?>
                        </td>
                        <td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="Titutlo_modal_payment_2">Como deseja pagar? <span id="valor_fat"></span></h5>
        ...
        <div class="row">
          ...
          <div class="col-md-12 margin">
            ...
            <div id="como_pagar" class="row">
              ...
              <div <?php if ($user->af == 0 || $user->af == NULL) { ?> class="col-md-4" <?php } else { ?>
                  class="col-md-12  text-center" <?php } ?> id="mercadopago_div">
                <button onclick="meio_pay('ted');" id="btn_mp_pay" class="btn btn-lg btn-outline-secondary">Pagamento
                  por Pix </button>
              </div>
            ...
            <div style="display:none;" id="row_ted" class="row">
              <div style="margin-bottom:10px;" class="col-md-12">
                <button class="btn btn-secondary btn-sm" onclick="$('#row_ted').hide();$('#como_pagar').show(100);"> <i
                    class="fa-arrow-left fa"></i> Voltar</button>
              </div>
              ...
              <div class="col-md-6">
                ...
                <ul>
                  ...
                  <li>
                    Titular: <b>Gabriel Correa Paes</b>
                  </li>
                  <li>
                    CHAVE PIX: <b>b7ca7176-cd81-40e2-9a73-546c6f753355</b>
                  </li>
                  <center><strong>
                      <font size="4" color="#7922ff">QRCODE PIX</font>
                    </strong><br>
                    <!-- <p>QR Code temporariamente indisponível</p> -->
                    <img src="https://gestormaster.top/painel/img/qrcode-pixGCP.png?" alt="Pix" width="70%"  /><br />
                    <!-- <img src="https://gestormaster.top/gmaster/painel/img/qrcode-pixGCP.png?" alt="Pix" width="70%"  /><br /> -->
                    <center><strong>
                        <font size="4" color="#7922ff">Pix copia e cola</font>
                      </strong><br>
                      <span>b7ca7176-cd81-40e2-9a73-546c6f753355</span>
              ...
              <div class="col-md-6">
                ...
                <p>Precisa enviar o comprovante pelo celular ? Escaneie o QrCode Abaixo ou digite o endereço na barra de
                  pesquisa.</p>
                <p id="dados_mobile"></p>
              </div>
...
<div class="modal fade" id="modal_payment_paypal" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="Titutlo_modal_payment_paypal">
          <?= $idioma->ta_quase_la; ?>
          <?= explode(' ', $user->nome)[0]; ?>
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
...
<div class="modal fade" id="modal_codigo_promo" tabindex="-1" role="dialog" aria-labelledby="Titutlo_modal_codigo_promo"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="Titutlo_modal_payment">
          <?= explode(' ', $user->nome)[0]; ?>, utilize um código promocional.
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body" id="">
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center margin">
            ...
            <div class="form-group">
              <button id="valida_cod" class="btn btn-success btn-sm" onclick="aply_promo();">Validar</button>
            </div>
...
<script>
  ...
  function meio_pay(meio) {
    ...
    if (meio == 'mp') {
      ...
      $("#como_pagar").hide();
      $("#row_ted").show(100);
      $("#dados_mobile").html('<center><img src="../qrcodes/imgs/' + idFat + '.png" /><br /><b>https://gestormaster.top/gmaster/c/' + idFat + '</b></center>');
    } else if (meio == "paypal") {
      $("#modal_payment_2").modal('toggle');
