...
<link href="https://gestormaster.top/painel/css/chatbot.css" rel="stylesheet">
      ...
      <div class="col-md-12">
        ...
        <div style="margin-bottom:10px!important;" class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            ...
            <?php if($getChatbot){ ?>
             <button onclick="$('#modal_add_reply').modal('show');" type="button" class="btn btn-sm btn-outline-secondary"><i class="fa fa-plus" ></i> Nova Resposta</button>
            <?php } ?>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="text-center col-md-12">
                <img width="300" src="https://gestormaster.top/painel/img/init_settings_bot.png" />
                <br /><br />
                 ...
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12" style="margin-left:10px;">
                              ...
                              <p>
                                ...
                                <ol>
                                    <li>
                                        Baixe o Aplicativo Auto Reply <a target="_blank" href="https://play.google.com/store/apps/details?id=com.pransuinc.autoreply&hl=pt-pt">clicando aqui</a>
                                    </li>
                                    <br />
                                    <li>
                                        Inicie o app, e dê todas as permissões que o app pede.
                                    </li>
                                    <br />
                                    <li>
                                    ...
                                    <li>
                                        No campo que diz Server URL, coloque o seguinte link: <b class="text-info">https://gestormaster.top/gmaster/b/m.php?key=<?= $user->id; ?></b>
                                    </li>
                                    <br />
                                    <li>
                     ...
                     <div class="modal-footer">
                       <a target="_blank" href="https://youtu.be/1AsS04QFB4s?si=FIDrMNARKlMre6M6" id="btn_add_cvd" class="btn btn-info"> <i class="fa fa-play"></i> Assistir um tutorial</a>
                       <a target="_blank" href="https://gestormaster.top/contato" id="btn_add_cvd" class="btn btn-secondary">Suporte</a>
                   ...
                   <tr>
                      ...
                      <td width="200" class="text-center" >
                        <?php if($user->id == '156'){?>
                          ...
                          <button onclick="edit_reply(<?= $reply->id; ?>);" title="EDITAR" type="button" class="btn-outline-info btn btn-sm btn-outline-info"  id="btn_edit_reply_<?= $reply->id; ?>"> <i  id="_btn_edit_reply_<?= $reply->id; ?>" class="fa fa-pencil" ></i></button>


                        <?php } ?>
                        <button onclick="deletar_reply(<?= $reply->id; ?>);" title="DELETAR" type="button" class="btn-outline-info btn btn-sm btn-outline-danger"  id="btn_remove_reply_<?= $reply->id; ?>"> <i  id="_btn_remove_reply_<?= $reply->id; ?>" class="fa fa-trash" ></i></button>
                      </td>
                    </tr>
...
<!--  Modal edit reply -->
<div class="modal fade" id="modal_edit_reply" tabindex="-1" role="dialog" aria-labelledby="TituloModalLongoExemplo" aria-hidden="true">
 <div class="modal-dialog" role="document">
   <div class="modal-content">
     <div class="modal-header">
     ...
     <div class="modal-footer">
       ...
       <button type="button" onclick="edit_reply('texto');" id="btn_edit_reply_texto" class="btn btn-primary"><?= $idioma->salvar; ?></button>
       <button type="button" onclick="edit_reply('dados');" id="btn_edit_reply_dados" style="display:none;" class="btn btn-primary"><?= $idioma->salvar; ?></button>
       <button type="button" onclick="edit_reply('teste');" id="btn_edit_reply_teste" style="display:none;" class="btn btn-primary"><?= $idioma->salvar; ?></button>
     </div>
...
<div class="modal fade" id="modal_add_reply" tabindex="-1" role="dialog" aria-labelledby="TituloModalLongoExemplo" aria-hidden="true">
 ...
 <script src="https://gestormaster.top/painel/js/chatbot.js?v=<?= filemtime('js/chatbot.js'); ?>"></script>
