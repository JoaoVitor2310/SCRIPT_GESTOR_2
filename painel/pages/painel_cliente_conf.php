...
<div class="">
            ...
            <div style="padding: 10px;-webkit-box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);width: 99%;" class="card row" >
              ...
              <div class="col-md-12">
                <h1 class="h2 h2-cell"><?= $idioma->faca_conf_painel_cliente; ?></h1>
                <?php if($area_cli_conf){ ?>
                <div class="btn-toolbar mb-2 mb-md-0">
                  <div style="margin-bottom:10px;" class="btn-group mr-2">
                    <a href="https://cliente.gestormaster.top/<?= $area_cli_conf->slug_area;?>" target="_blank" type="button" class="btn btn-sm btn-outline-secondary"><i class="fa fa-external-link" ></i> <?= $idioma->acessar_area_clie; ?></a>
                       ...
                       <div class="col-md-12" >
                         <div class="row" style="margin-bottom:10px;" >
                           <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="<?= 'https://'.$gestor_class->get_options("dominio").'/gmaster/a/'.str_replace('=','',base64_encode($user->id));?>" placeholder="Link de area cliente" id="input_link_area_cli" value="" >
                                  <div class="input-group-append">
                                    <a onclick="copy_link_a_cli();" class="btn btn-outline-secondary" style="cursor:pointer;" id="abrir_link_pay" >Copiar <i class="fa fa-files-o" ></i></a>
                                  </div>
                                </div>
                           ...
                           <div class="col-md-4">
                                <div class="input-group">
                                  <input type="text" class="form-control" value="<?= 'https://'.$gestor_class->get_options("dominio").'/gmaster/a/'.str_replace('=','',base64_encode($user->id));?>/c" placeholder="Link de area cliente" id="input_link_area_create" value="" >
                                  <div class="input-group-append">
                           ...
                           <div class="col-md-4 text-right">
                             <button type="button" class="btn btn btn-outline-secondary" onclick="$('#modal_add_aviso').modal('show');" name="button"><i class="fa fa-plus" ></i> <?= $idioma->novo_aviso; ?></button>
                           </div>
                         </div>
