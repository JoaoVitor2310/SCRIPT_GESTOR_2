        ...
        <div style="margin-bottom:10px;" class="col-md-8">
            <div class="btn-toolbar ">
              <div class="btn-group mr-3">
                <button onclick="$('#modal_gestorBot').modal('show');" class="btn btn-outline-secondary" ><i class="fa fa-grav" ></i> Gestor-Bot <span class="badge badge-success">EM BREVE</span></button>
                <button onclick="$('#modal_pareamento').modal('show');" class="btn btn-outline-secondary" ><i class="fa fa-key" ></i> Configurar Credenciais</button>
                <!--<button onclick="$('#modal_pareamento_zapi').modal('show');" class="btn btn-outline-secondary" ><i class="fa fa-whatsapp" ></i> Api Patrão  <?php if($user->id_plano != 7){ echo '<i class="fa fa-star text-primary"></i>';} ?></button>-->
                        ...
                        <div class="col-md-12" >
                            <div class="">
                                <ul>
                                    ...
                                    <li>
                                        <p>
                                            A api <b>Gestor-bot</b> é uma instância gratuita fornecida pela Gestor Master. As mensagens são enviadas automáticamente se ativada.
                                        </p>
                                        <p>
                                           <i class="fa fa-hand-o-right"></i> Nós temos um número próprio para o envio das mensagens. <b>+55 (45) 9808-6201</b>. É importante se você usar está api, pedir que seus clientes adicione este número em suas agendas.
                                        </p>
                                        <p>
...
<div class="modal fade"  data-backdrop="static" id="modal_pareamento_zapi" tabindex="-1" role="dialog" aria-labelledby="Titutlo_modal_pareamento" aria-hidden="true">
 <div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
     <div class="modal-header">
       <h5 class="modal-title" id="Titutlo_modal_fat_cli">Utilizar API <span class="badge badge-danger" >BETA</span></h5>
       <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>
     ...
     <div class="modal-body " id="body_modal_pareamento" >
        ...
        <div class="row" >
            ...
            <div class="col-md-12" >
                    ...
                    <!--    <div class="col-md-3 form-group" >-->
                    <!--        <img src="<?php if($dark == 1){ echo "https://".$gestor_class->get_options("dominio")."/painel/img/logo-gestor-lite_dark_on.png"; }else{ echo 'https://'.$gestor_class->get_options("dominio").'/painel/img/logo-gestor-lite.png'; }?>" width="150" />-->
                    <!--    </div>-->
                    ...
                    <!--     <div class="col-md-3 form-group" >-->
                    <!--      <a target="_blank" href="https://gestormaster.topm/painel/cart" >Visitar <i class="fa fa-globe" ></i></a> |-->
