    ...
    <main class="page-content">
        ...
        <div class="">
            ...
            <div style="-webkit-box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);box-shadow: 0px 0px 16px -2px rgb(0 0 0 / 84%);width: 99%;" class="card row full" >
                ...
                <!-- title and btns -->
                <div class="col-md-6">
                    <h2 class="h2 h2-cell">Chat Bot</h2><br />
                </div>
                <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row list_contacts" style="overflow-y:scroll;max-height:500px;">
                                ...
                                <div onclick="organize_messages(<?= $chat->id; ?>,'<?= $name;?>');" class="card col-md-12" style="cursor:pointer;padding-bottom:5px;padding-top:5px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="msg-img" style="background-image: url(https://gestormaster.top/painel/img/profile_chat.svg)" ></div>
                                        </div>
                                        <div class="col-md-8">
                             ...
                             <section style="max-width: 75%;" class="msger">
                                  ...
                                  <header class="msger-header">
                                    <div class="msger-header-title">
                                      <i class="fas fa-comment-alt"></i> Cortesia de Gestor Master
                                    </div>
                            ...
                            <div class="col-md-12" style="margin-left:10px;">
                              ...
                              <p>
                                ...
                                <ol>
                                    ...
                                    <br />
                                    <li>
                                        No painel Gestor Master, basta clicar em configurar para adicionar as respostas automáticas.
                                    </li>
                                </ol>
...
<script>
    ...
    function organize_messages(chat,name){
        ...
        $.post('../control/control.organizechat.php',{messages:jsonChat,name:name},function(data){
            if(data == ""){
                $(".msger-chat").html('<center><img width="300" src="https://gestormaster.top/painel/img/robot_default.png" /></center>');
            }else{
