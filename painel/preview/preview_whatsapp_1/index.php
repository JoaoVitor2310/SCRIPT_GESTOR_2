<?php
  ...
  if(isset($_GET['msg'])){
    ...
    $array2 = array("senha#exemplo","Raul Seixas","Raul","cliente_mail@gestormaster","5544991136458","14/01/2020",$plano_nome,str_replace(' ','',str_replace('R$','',$valor)),date('d/m/Y'),'https://gestormaster.top/gmaster/p/GWg');
