window.onload = function(e){
   ...
   function select_pacote(){
       ...
       $.get('https://localhost/gmaster/painel/api.php?chave='+chave+'&getPackages&trial',function(data){
           try{
   ...
   function organize_messages(chat,name){
       ...
       $.post('../control/control.organizechat.php',{messages:jsonChat,name:name},function(data){
           if(data == ""){
               $(".msger-chat").html('<center><img width="300" src="https://localhost/gmaster/painel/img/robot_default.png" /></center>');
           }else{
