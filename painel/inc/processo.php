<?php
  ...
  if($dataVen_user == $dataHoje_user){
      $ven_user = "<b class='badge badge-primary'>Seu painel Gestor Master, vence hoje: {$user->vencimento}</b>";
  }else if($dataHoje_user > $dataVen_user){
 
     if($user->vencimento == "00/00/0000"){
       $ven_user = "<b class='badge badge-info'>Escolha um plano Gestor Master</b>";
     }else{
       $ven_user = "<b class='badge badge-danger'>Painel Gestor Master vencido, renove</b>";
     }
