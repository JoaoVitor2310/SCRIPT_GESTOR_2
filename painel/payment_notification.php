                   ...
                   if($plano){
                       ...
                       if($dono){
                           ...
                           if($explo_url[2] == 'mercadopago'){
                              ...
                              echo '<script>location.href="https://cliente.gestormaster.top";</script>';
                                        ...
                                        if($notification){
                                            ...
                                            if($info_notification->status == "approved"){
                                                ...
                                                if($renew){
                                                    ...
                                                    $saudacao[1] = "*PAGAMENTO RECEBIDO VIA GESTOR MASTER*.";
                                                    // $saudacao[1] = "Olá {nome_dono}.";
                                                    ...
                                                    $string_dono = $saudacao[1]."\n\nOlá {nome_dono}.\n\nUm cliente pagou o plano *{plano_nome}*, utlizando o Gestor Master. \n\nE estou aqui para te notificar desta transação.\n\nSegue os dados:\n*Data*: {data}\n*Cliente*: {nome_cliente}\n*Valor*: R$ {valor}\n*Forma*: {forma}\n*Status*: {status}\n*Zap Cliente*: {zap_cliente}\n\nPara mais informações acesse o seu painel gestor.".$saudacaoF[1];
                                                    $string_cli  = "Oi {nome_cliente}. Seu pagamento de R$ {valor} para o plano {plano_nome}, foi aprovado! \n\n Em caso de dúvidas ou suporte, responda esta mensagem com sua dúvida.";
                                                    ...
                                                    // enviar dono
                                                    $whatsapi_class->fila($zap_dono,$text_dono,$dono->id,'ZAPI','ZAPI','0000','0000',"pagamento_aprovado");
                                                    // fim evia dono 
                                            ...
                                            echo "<br />Redirecionando... <script>setTimeout(function(){location.href='https://cliente.gestormaster.top/';},2000);</script>";
                                        }
