        ...
        if($dados){
          ...
          if($dados->nome != "" && $dados->plano_id != "" && $dados->text_delivery != ""){
            ...
            if($delivery->verific_deliverys($plano_gestor->deliverys,$_SESSION['SESSION_USER']['id'])){
              echo '{"erro":true,"msg":"<h3>Desculpe, você não pode adicionar mais envios em seu plano gestor atual. <a href=\'gestormaster.top/painel/cart?upgrade\'>Faça um upgrade</a></h3>"}';
              die;
            }
