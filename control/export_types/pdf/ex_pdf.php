 ...
 $html = "
     ...
     <p  style='font-family:arial;' >Da data  <b>$data1</b> até a data de <b>$data2</b></p>
      ...
      <table class='blueTable'>
        <thead>
          ...
          <tbody>";
           ...
           <hr>
           <div class='copy' >
             <p>PDF By Gestor Master - ".date('Y')." &copy; </p>
           </div>";
      ...
      fieldset p{
       ...
       $mpdf->WriteHTML($html);
       $mpdf->Output('financeiro_gestor_master.pdf');

       header("Content-type:application/pdf");
       header("Content-Disposition:attachment;filename=financeiro_gestor_master.pdf");
       readfile("financeiro_gestor_master.pdf");

        if(is_file("financeiro_gestor_master.pdf")){
          unlink("financeiro_gestor_master.pdf");
        }
