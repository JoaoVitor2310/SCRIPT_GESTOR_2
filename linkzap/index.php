<?php 
  ...
  * Propriedade de Gestor Master
  * 2020 - @author - Luan Alves
  * linkzap.me | gestormaster
  */
...
//   $osData = json_decode($output);
   ...
   $http_reference = @$_SERVER['HTTP_REFERER'] ? @$_SERVER['HTTP_REFERER'] : "https://gestormaster.top";
           ...
           if($explo_url[0] != 'error'){
               ...
               if($getlink){
                   ...
                   if ( $detect->isMobile() ) {
                    ...
                    $dados->origem      = str_replace('gestormaster','Acesso direto',$info_acesso['origem']);
