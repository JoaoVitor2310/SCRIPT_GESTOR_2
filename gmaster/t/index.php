...
<head>
	...
	<meta property="og:url"                content="https://<?= $gestor_class->get_options("dominio");?>/gmaster/t/<?= $chave; ?>" />
    ...
    <meta property="og:image"              itemprop="image" content="https://<?= $gestor_class->get_options("dominio");?>/gmaster/t/images/BANNER-COMPARTILHAR.png" />
				...
				<div class="col-md-4 wrap-input100 validate-input" data-validate = "Digite um email válido. ex: eu@gmail.com">
					<div  class="btn-group">
						...
						<button style="font-size: 0.8rem;" id="dropDownDDI" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/br.png" /> +55
						</button>
						<div class="dropdown-menu">
							<a style="cursor:pointer;" onclick="mudaDDI('55','br')" class="dropdown-item"><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/br.png" /> +55</a>
							<a style="cursor:pointer;" onclick="mudaDDI('351','pt');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/pt.png" /> +351</a>
							<a style="cursor:pointer;" onclick="mudaDDI('1','usa');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/usa.png" /> +1</a>
							<a style="cursor:pointer;" onclick="mudaDDI('49','ger');" class="dropdown-item"><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/ger.png" /> +49</a>
							<a style="cursor:pointer;" onclick="mudaDDI('54','arg');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/arg.png" /> +54</a>
							<a style="cursor:pointer;" onclick="mudaDDI('598','uru');" class="dropdown-item"><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/uru.png" /> +598</a>
							<a style="cursor:pointer;" onclick="mudaDDI('44','gbr');" class="dropdown-item"><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/gbr.png" /> +44</a>
							<a style="cursor:pointer;" onclick="mudaDDI('34','esp');" class="dropdown-item"><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/esp.png" /> +34</a>
							<a style="cursor:pointer;" onclick="mudaDDI('1','can');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/can.png" /> +1</a>
							<a style="cursor:pointer;" onclick="mudaDDI('57','col');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/col.png" /> +57</a>
						    <a style="cursor:pointer;" onclick="mudaDDI('244','ao');" class="dropdown-item" ><img class="img_btn" src="https://<?= $gestor_class->get_options("dominio");?>/img/country/ao.png" /> +244</a>
...
<!--===============================================================================================-->
  ...
  <script src="https://<?= $gestor_class->get_options("dominio");?>/login/js/jquery.mask.js"></script>
	<!--===============================================================================================-->
...
<!--===============================================================================================-->
    ...
    function mudaDDI(ddi,country){
          ...
          $("#ddi").val(ddi);
          $("#dropDownDDI").html('<img src="https://<?= $gestor_class->get_options("dominio");?>/img/country/'+country+'.png" /> +'+ddi);
      }
