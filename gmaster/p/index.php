  ...
  <!-- Gestor Master notify -->
    <script>
       (function(d, s, id) {
        ...
        js.src = 'https://<?= $gestor_class->get_options("dominio");?>/notify-gestor/notify-gestorlite.js?v=9';
...
<?php if($auth){ ?>
    ...
    <div style=" padding-left: 0;" class="  col-lg-offset-2 col-md-8 col-lg-5 col-xs-12  ">
      ...
      <div class="col-lg-12 col-xs-12 padding-l-r-zero" id="divPagamento" style="margin-top: -18px;">
              ...
              <div  class="panel panel-default col-xs-12" id="detalhes" style="padding: 0px;">
                <div class="panel-body padding-l-r-zero"  style="text-align: center;padding: 0px;">
						...
						<div style="min-height:60px;" class="panel-heading text-right">
							<a target="_blank" style="text-decoration:none;" href="https://<?= $gestor_class->get_options("dominio");?>">
								<span style="color: gray;font-size: 9px;">POWERED BY <img style="filter: gray;-webkit-filter: grayscale(100%);" width="50" src="https://<?= $gestor_class->get_options("dominio");?>/img/logo.png" alt=""> </span>
							</a>
  						    </div>
								<style media="screen">
		...
		<script src="https://gestormaster.top/gmaster/p/js/main.js?v=1.2"></script>
