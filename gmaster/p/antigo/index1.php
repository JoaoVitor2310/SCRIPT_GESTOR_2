...
<html lang="pt-br">
   <head>
	  ...
	  <link href="https://gestormaster.top/gmaster/assets/css/bootstrap.min.css" rel="stylesheet">
	  <link href="https://gestormaster.top/gmaster/assets/css/icons/css/font-awesome.min.css" rel="stylesheet">
      <style>
	  body {
                         ...
                         <div class="card-details__expiration-date">
    					  ...
    					  <input type="hidden" id="ddi" value="55" />
    						...
    						<button style="font-size: 0.8rem;" id="dropDownDDI" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    							<img class="img_btn" src="https://gestormaster.top/img/country/br.png" /> +55
    						</button>
    						<div class="dropdown-menu">
    							<a style="cursor:pointer;" onclick="mudaDDI('55','br')" class="dropdown-item"><img class="img_btn" src="https://gestormaster.top/img/country/br.png" /> +55</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('351','pt');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/pt.png" /> +351</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('1','usa');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/usa.png" /> +1</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('49','ger');" class="dropdown-item"><img class="img_btn" src="https://gestormaster.top/img/country/ger.png" /> +49</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('54','arg');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/arg.png" /> +54</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('598','uru');" class="dropdown-item"><img class="img_btn" src="https://gestormaster.top/img/country/uru.png" /> +598</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('44','gbr');" class="dropdown-item"><img class="img_btn" src="https://gestormaster.top/img/country/gbr.png" /> +44</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('34','esp');" class="dropdown-item"><img class="img_btn" src="https://gestormaster.top/img/country/esp.png" /> +34</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('1','can');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/can.png" /> +1</a>
    							<a style="cursor:pointer;" onclick="mudaDDI('57','col');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/col.png" /> +57</a>
    						</div>
    					</div>
                         </div>
                      </div>
    	...
    	<?php }else{ ?>
		 ...
		 <?php } ?>
		  ...
		  function mudaDDI(ddi,country){
			  ...
			  $("#ddi").val(ddi);
			  $("#dropDownDDI").html('<img class="img_btn" src="https://gestormaster.top/img/country/'+country+'.png" /> +'+ddi);
		  }
		</script>
      
      
	  <script src="https://gestormaster.top/gmaster/assets/js/jquery.js"></script>
	  <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js" ></script>
	  <script src="https://gestormaster.top/gmaster/assets/js/popper.js"></script>
	  <script src="https://gestormaster.top/gmaster/assets/js/bootstrap.min.js"></script>
	  <script src="https://gestormaster.top/gmaster/assets/js/jquery.mask.js"></script>
	  <script src="https://gestormaster.top/gmaster/p/js/main.js"></script>
