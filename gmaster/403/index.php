...
<html lang="pt-br">
   <head>
	  ...
	  <link href="https://gestormaster.top/painel/css/bootstrap.min.css" rel="stylesheet">
	  <link href="https://gestormaster.top/painel/css/icons/css/font-awesome.min.css" rel="stylesheet">
      <style>
	  body {
   ...
   <body translate="no">
	  ...
	  <script src="https://gestormaster.top/painel/js/jquery.js"></script>
	  <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js" ></script>
	  <script src="https://gestormaster.top/painel/js/popper.js"></script>
	  <script src="https://gestormaster.top/painel/js/bootstrap.min.js"></script>
