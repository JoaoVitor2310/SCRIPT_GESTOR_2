...
<!--===============================================================================================-->
 <link rel="stylesheet" href="https://gestormaster.top/css/font-awesome.min.css"/>
...
<body>
    ...
    <!--							<a style="cursor:pointer;" onclick="mudaDDI('57','col');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/col.png" /> +57</a>-->
				<!--		    	<a style="cursor:pointer;" onclick="mudaDDI('81','jp');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/jp.png" /> +81</a>-->
    <!--							<a style="cursor:pointer;" onclick="mudaDDI('244','ao');" class="dropdown-item" ><img class="img_btn" src="https://gestormaster.top/img/country/ao.png" /> +244</a>-->
    ...
    <!--    </script>-->
				...
				<!--</div>-->
                  ...
                  <span style="font-size:12px;" >
                    <a style="color:blue;" target="_blank" href="https://gestormaster.top/termos/termos-gestor.pdf"><i class="fa fa-external-link" ></i> Termos </a> - Ao criar a conta você concorda com os termos
                  </span>
