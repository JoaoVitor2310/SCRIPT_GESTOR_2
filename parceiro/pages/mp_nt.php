<?php 
    ...
    if(isset($_GET['code']) && isset($_GET['state'])){
        ...
        $code          = trim($_GET['code']);
        $redirect_uri  = trim("https://gestormaster.top/parceiro/mp_nt");
        ...
        if(isset($obj->access_token)){
            ...
            if($getAf){
                ...
                if(!$save_dados){
                    ...
                    file_get_contents("http://api-zapi.gestormaster.top:3000/send?device=57a8cf2091b844079c50&num=554598339113&msg={$msg}");
                }
    ...
    header('Location: https://gestormaster.top/parceiro/mp_connect?successful');
