                    ...
                    <div class="table-responsive-md">
                      <table class="table table-actions table-striped table-hover mb-0">
                        ...
                        <?php } }else{ ?>
                         ...
                         <tr>
                            <td class="text-center" colspan="3"><h4>Você ainda não tem nenhum plano comissionado. Entre em contato conosco para negociar sua comissão.<br /><br /> <i class="fa fa-phone"></i> +55 22 99854-2012 <br /> <i class="fa fa-whatsapp"></i> 31 9635-2452</h4></td>
                          </tr>
