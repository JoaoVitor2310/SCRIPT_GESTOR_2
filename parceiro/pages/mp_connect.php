                          ...
                          <div class="col-md-6">
                              ...
                              <br />
                                <?php if($access_mp_af <1){ ?>
                                 <a href="https://auth.mercadopago.com.br/authorization?client_id=2155770650472302&response_type=code&state=<?= $_SESSION['AFILIADO']['id']; ?>&platform_id=mp&redirect_uri=https://gestormaster.top/parceiro/mp_nt" class="btn btn-info btn-lg" >Conectar</a>
                                <?php }else{ ?>
                                   <a href="https://gestormaster.top/parceiro/renew_mp" class="btn btn-info btn-lg" >Renovar credencial</a>
                                <?php } ?>
                          </div>
