...
function loadcss(){
 ...
 css.rel    = 'stylesheet';
 css.type   = 'text/css';
 css.href   = 'https://localhost/gmaster/notify-gestor/notify-gestorlite.css?v=4';
 css.media = 'all';
...
var url = 'https://localhost/gmaster/notify-gestor/get.php?member='+memberidGl;
...
var html_notify = '<div class="notify-gestor-'+position+' notify-gestor-container" id="notify-gestor-lite-div" ><div class="notify-gestor-body"><div class="notify-col-4"><img src="https://localhost/gmaster/notify-gestor/icon-128x128.gif" alt=""></div><div class="notify-col-8"><div class="notify-gestor-title">';
...
html_notify += '</div></div></div><div class="notify-gestor-footer"><a class="notify-gestor-link-copyright" href="https://localhost/gmaster" target="_blank">';
