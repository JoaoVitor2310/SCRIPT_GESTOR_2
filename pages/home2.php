...
<html lang="pt-br">
<head>
	<title>Gestor Master - Gerenciamento facilitado de clientes</title>
	<meta charset="UTF-8">

	<meta name="keywords" content="Gestor Master, iptv gestor, gerenciamento de clientes,emissor de cobranças, whatsapi, cobrar clientes, automatico,emitir cobranças,controle financeiro,financeiro,planilha excel">
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="https://gestormaster.top/css/bootstrap.min.css"/>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"/>
	<link rel="stylesheet" href="https://gestormaster.top/css/flaticon.css"/>
	<link rel="stylesheet" href="https://gestormaster.top/css/owl.carousel.min.css"/>
	<link rel="stylesheet" href="https://gestormaster.top/css/animate.css"/>
	<link rel="stylesheet" href="https://gestormaster.top/css/style.css"/>
...
<body>
	...
	<header class="header-section">
		<a href="" class="site-logo"><img width="100" src="https://gestormaster.top/img/logo.png" alt=""></a>
		<div class="nav-switch">
			<i class="fa fa-bars"></i>
		</div>
		<div class="nav-warp">
			<div class="user-panel">
				<a href="https://gestormaster.top/login">Entrar</a> /
				<a href="https://gestormaster.top/login/create">Registrar</a>
			</div>
			<ul class="main-menu">
				<li><a href="https://gestormaster.top/contato">Contato</a></li>
				<!-- <li><a href="https://gestormaster.top/faq">FAQ</a></li> -->
				<li><a target="_blank" href="https://t.me/gestormaster">Base de conhecimento</a></li>
			</ul>
		</div>
	</header>
	<!-- Header section end -->
	...
	<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="https://gestormaster.top/img/bg.jpg">
			...
			<div class="hero-content text-white">
				<div class="row">
					<div class="col-lg-12 pr-0">
						...
						<a href="https://gestormaster.top/login/create" class="site-btn">5 dias grátis</a>
					</div>
				</div>
				<div class="">
	...
	<section class="features-section spad">
		<div class="container">
			<div class="section-title">
				<img width="80" src="https://gestormaster.top//img/section-title-icon.png" alt="#">
				<p>Gestor Master</p>
				...
				<div class="col-lg-12">
					<div class="testimonials-slider owl-carousel">
						<div class="text-center ">
							 <center><img src="https://gestormaster.top/img/review/IMGA_GESTORLITE.png" alt=""></center>
						</div>
	...
	<section class=" spad">
		<div class="container">
			<div class="row">
			    <h3 style="margin-bottom:20px;" >Gestor Master:</h3>
				<!-- Testimonials -->
			    	<div class="col-lg-12">
			    	    <center>
	...
	<section class=" spad">
		<div class="container">
			<div class="row">
				<!-- Testimonials -->
			    	<div class="col-lg-6">
                        <img alt="Gestor Master" title="Gestor Master" src="https://gestormaster.top/img/gestorlite_home.png" />
					</div>
					<div class="col-lg-6">
					    <br /><br />
                        <h4>
                            Com o Gestor Master você economiza seu tempo para fazer outras tarefas mais importantes! Deixe que nós cobramos seus clientes no dia exato !
                        </h4>
                        <br /><br />
                        <h4>
		...
		<div class="container">
			<div class="row">
				<!-- Testimonials -->
					...
					<div class="col-lg-6">
                        <img alt="Gestor Master" title="Gestor Master" src="https://gestormaster.top/img/GESTOR1.png" />
					</div>
		...
		<div class="container">
			<div class="row">
				<!-- Testimonials -->
			    	...
			    	<div class="col-lg-6">
                        <img alt="Gestor Master" title="Gestor Master" src="https://gestormaster.top/img/GESTOR3.png" />
					</div>
				...
				<div class="col-lg-4 col-md-8 offset-md-2 offset-lg-0">
					<div class="pricing-plan <?php if($plano->popular == 1){ echo "gold-plan";} ?>">
						...
						<div class="pricing-body">
							...
							<a href="https://gestormaster.top/login/create" class="site-btn">Selecionar</a>
						</div>
					</div>
				</div>
	...
	<!-- Banner section -->
	<section class="banner-section set-bg" data-setbg="https://gestormaster.top/img/banner-bg.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-9 banner-text text-white">
					<h3>Pague R$ 250,00 contratando um ano</h3>
					<p>Pague menos pagando por um ano inteiro o plano Profissional do Gestor Master.</p>
				</div>
				<div class="col-lg-3 text-left text-lg-right">
					<a href="?wpp&text=Gostaria de adquirir o plano de 1 ano do Gestor Masterhttps://gestormaster.top/faq" target="_blank" class="site-btn">Contratar</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="footer-widget about-widget">
						<img width="200" src="https://gestormaster.top//img/logo.png" alt="logo">
						<!-- <p>No ano de 2019 a Script Mundo lançou o painel Gestor, e devido ao grande sucesso, decidimos abrir novos horizontes lançando o Gestor Master. O painel Gestor Master diferente do gestor não há necessidades de possuir uma hospedagem para usa-lo, e além de tudo o WhatsAPI é incluso em qualquer pacote.</p> -->
					</div>
				</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<ul>
									...
									<li><a href="https://gestormaster.top" target="_blank" >Gestor Master</a></li>
									<!-- <li><a href="https://gestormaster.top/termos/termos-gestor.pdf" target="_blank" >Termos de uso</a></li> -->
									<li><a href="https://gestormaster.top/faq?contato" target="_blank" >Contato</a></li>
								</ul>
							</div>
				...
				<!-- <div class="col-lg-4 col-md-3">
					<div class="footer-widget about-widget">
						<img width="200" src="https://gestormaster.top/painel/img/ferramenta-scriptmundo_dark_on.png" alt="logo">
...
Estamos localizados no Paraná desde a fundação. </p>
						<div class="fw-social social">
							...
							<a href="https://gestormaster.top/faq?wpp&text=" target="_blank" ><i class="fa fa-whatsapp"></i></a>
						</div>
	...
	<footer class="footer-section">
		<div class="container">
			<ul class="footer-menu">
				<li><a href="https://gestormaster.top/login" >Entrar</a></li>
				<li><a href="https://gestormaster.top/login/create" >Criar conta</a></li>
				<li><a href="https://gestormaster.top/faq?contato" target="_blank" >Contato</a></li>
			</ul>
			<div class="copyright">
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados 
<!-- | Uma ferramenta de <a href="https://scriptmundo.com" target="_blank">Script Mundo</a> -->
</div>
		</div>
	</footer>
	<!-- Footer top section end -->
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="https://gestormaster.top/js/jquery-3.2.1.min.js"></script>
	<script src="https://gestormaster.top/js/bootstrap.min.js"></script>
	<script src="https://gestormaster.top/js/owl.carousel.min.js"></script>
	<script src="https://gestormaster.top/js/circle-progress.min.js"></script>
	<script src="https://gestormaster.top/js/main.js"></script>
