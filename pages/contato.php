...
<html lang="pt-br">
<head>
	<title>Gestor Master - Contato</title>
	<meta charset="UTF-8">

	<meta name="keywords" content="faq, suporte gestor, Gestor Master, iptv gestor, gerenciamento de clientes,emissor de cobranças, whatsapi, cobrar clientes, automatico,emitir cobranças,controle financeiro,financeiro,planilha excel">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Gestor Master - Contato - Suporte">
...
<body>
	...
	<header class="header-section">
		...
		<div class="nav-warp">
			...
			<ul class="main-menu">
				<li ><a class="text-primary" href="https://gestormaster.top/contato">Contato</a></li>
				<!-- <li><a class="text-primary" href="https://gestormaster.top/faq">FAQ</a></li> -->
				<!-- <li><a class="text-primary" target="_blank" href="https://t.me/gestormaster">Base de conhecimento</a></li> -->
			</ul>
		</div>
	</header>
	<!-- Header section end -->
                ...
                <div class="form-group col-md-1" >
                 ...
                 <div class="btn-group">
    				<button id="dropDownDDI" id="btn_drop_ddi" type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    					<img src="https://gestormaster.top/img/country/br.png" /> +55
    				</button>
    				<div class="dropdown-menu">
    					<a style="cursor:pointer;" onclick="mudaDDI('55','br')" class="dropdown-item"><img src="https://gestormaster.top/img/country/br.png" /> +55</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('351','pt');" class="dropdown-item" ><img src="https://gestormaster.top/img/country/pt.png" /> +351</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('1','usa');" class="dropdown-item" ><img src="https://gestormaster.top/img/country/usa.png" /> +1</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('49','ger');" class="dropdown-item"><img src="https://gestormaster.top/img/country/ger.png" /> +49</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('54','arg');" class="dropdown-item" ><img src="https://gestormaster.top/img/country/arg.png" /> +54</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('598','uru');" class="dropdown-item"><img src="https://gestormaster.top/img/country/uru.png" /> +598</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('44','gbr');" class="dropdown-item"><img src="https://gestormaster.top/img/country/gbr.png" /> +44</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('34','esp');" class="dropdown-item"><img src="https://gestormaster.top/img/country/esp.png" /> +34</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('1','can');" class="dropdown-item" ><img src="https://gestormaster.top/img/country/can.png" /> +1</a>
    					<a style="cursor:pointer;" onclick="mudaDDI('57','col');" class="dropdown-item" ><img src="https://gestormaster.top/img/country/col.png" /> +57</a>
    				</div>
    			</div>
...
Estamos localizados no Paraná desde a fundação. </p>
	...
	<footer class="footer-section">
		<div class="container">
			<ul class="footer-menu">
				...
				<li><a href="https://gestormaster.top/faq?contato" >Contato</a></li>
			</ul>
			<div class="copyright">
    ...
    function zera_campos(){
        ...
        $("#msg_contato").val('');
        $("#btn_drop_ddi").html('<img src="https://gestormaster.top/img/country/br.png" /> +55');
    }
