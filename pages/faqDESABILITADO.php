	...
	<section class="section spad"  >
		<div class="container">
			<div class="section-title">
				...
				<p style="margin-top:20px;" >Consulte nosso <a target="_blank" href="https://t.me/gestormaster">Base de conhecimento</a></p>
			</div>
			<div class="row" style="text-align:left!important;">
				<div style="margin-top:20px;" class="col-lg-12 col-md-6 ">
					<h4>Posso importar clientes a partir do excel?</h4>
					<p>Não. O Gestor Master aceita somente a importação de clientes exportados do próprio Gestor Master, ou do Gestor Convencional. </p>
				</div>
				<hr>
				<div style="margin-top:20px;" class="col-lg-12 col-md-6 ">
