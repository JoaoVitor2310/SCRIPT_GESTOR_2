...
<html lang="pt-br">
  <head>
    ...
    <meta name="keywords" content="chatbot whatsapp, Gestor Master, iptv gestor, gerenciamento de clientes,gerenciador de clientes, emissor de cobranças, whatsapi, cobrar clientes, automatico,emitir cobranças,controle financeiro,financeiro,planilha excel">
    ...
    <div class="hero-wrap js-fullheight">
      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
            <img class="one-third align-self-end order-md-last img-fluid" src="https://gestormaster.top/img/8888.png" alt="">
        <div   class="one-forth d-flex align-items-center ftco-animate js-fullheight">
	        	<div style="margin-top: -267px!important;position: relative;" class="text mt-5">
  	            <h1 class="mb-1"><span style="COLOR: #6927ff;font-family: 'montserrat';" >NUNCA MAIS PAGUE MENSALIDADE</span></h1>
	            <p>
	              Seja nosso sócio nessa empreitada! E nunca mais pague sua assinatura.
                </p>
    		...
    		<div class="row justify-content-center mb-5">
              <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
                  <div class="col-md-12 text-center heading-section ftco-animate">
                    ...
                    <h2 id="valor_b2c" style="color:#6927ff;" >R$ <?= file_get_contents("https://gestormaster.top/system/cont_user.php?mov_b2b");?></h2>
                    <p style="color:#000;" >
    ...
    <section class="ftco-section ftco-no-pt ftc-no-pb">
    	<div class="container">
    		<div class="row">
	            ...
	            <p>
	                O painel Gestor Master, é integrado com as melhores gateways de pagamento. Possibilitando que seu cliente, através do seu link faça o pagamento de forma rápida segura e simples. Você é notificado na mesma hora que seu cliente efetuar o pagamento.
	            </p>
	          </div>
    			</div>
    			<div class="col-lg-6 py-5">
    	...
    	<div class="container">
    		<div class="row">
    	 	 ...
    	 	 <div class="col-lg-6 py-5">
    	            ...
    	            <p>
    	                É por isso que a Gestor Master, oferece um link de pagamento para que você envie para clientes, por qualquer midia social. Um link que reune as melhoras formas de pagamentos que você definir em seu painel.
    	            </p>
                </div>
 ...
 <section class="ftco-section ftco-no-pt ftc-no-pb">
    	<div class="container">
    		<div class="row text-center">
    			...
    			<div class="col-md-3 py-5">
    				<img title="Portal Comunique-se" src="https://gestormaster.top/assets/images/news/portal-comunique-se.png" class="img-fluid" alt="">
    			</div>
    			<div class="col-md-3 py-5">
    				<img title="Estadão" src="https://gestormaster.top/assets/images/news/estadao.png" class="img-fluid" alt="">
    			</div>
    			<div class="col-md-3 py-5">
    				<img title="Mundo do Marketing" src="https://gestormaster.top/assets/images/news/mk.png" class="img-fluid" alt="">
    			</div>
	        ...
	        <div class="col-lg-4 col-md-6 ftco-animate">
	          <div class="block-7">
	            <div class="text-center">
		            ...
		            <a href="https://gestormaster.top/login/create" class="btn btn-primary d-block px-3 py-3 mb-4">Selecionar</a>
	            </div>
	          </div>
	        </div>
    	...
    	<div class="row justify-content-center mb-5 pb-3">
          ...
          <div class="row d-flex" style="width: 100%;">
              <div class="col-md-12" style="width: 100%;">
                  <iframe style="width: 100%!important;border: 0px;overflow-y: hidden;overflow-x: hidden;" class="iframe_compare" id="iframe-compare" src="https://gestormaster.top/pages/compare.html?v=1" width="100%" height="700px" ></iframe>
              </div>
          </div>
        </div>
    	</div>
          ...
          <div class="col-md-12 align-items-center ftco-animate">
            ...
            <div class="tab-content ftco-animate" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-nextgen" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
              	<div class="d-md-flex">
	              	...
	              	<div class="one-half ml-md-5 align-self-center">
		                <h2 class="mb-4">Nosso Base de conhecimento</h2>
              ...
              <div class="tab-pane fade" id="v-pills-performance" role="tabpanel" aria-labelledby="v-pills-performance-tab">
                <div class="d-md-flex">
	              	<div class="one-forth order-last align-self-center">
	              		<img src="https://gestormaster.top/assets/images/undraw_visual_data_b1wx.svg" class="img-fluid" alt="">
	              	</div>
	              	<div class="one-half order-first mr-md-5 align-self-center">
		                ...
		                <p><a href="https://gestormaster.top/login/create" class="btn btn-primary py-3">Criar conta grátis</a></p>
		              </div>
	              </div>
              </div>
              ...
              <div class="tab-pane fade" id="v-pills-effect" role="tabpanel" aria-labelledby="v-pills-effect-tab">
                <div class="d-md-flex">
	              	<div class="one-forth align-self-center">
	              		<img src="https://gestormaster.top/assets/images/undraw_business_plan_5i9d.svg" class="img-fluid" alt="">
	              	</div>
	              	<div class="one-half ml-md-5 align-self-center">
      ...
      <div class="container">
      	<div class="row mb-5 pb-5 align-items-center d-flex">
      		<div class="col-md-6">
      			<div class="heading-section heading-section-white ftco-animate">
      				<span class="subheading">Pague menos pagando por um ano inteiro o plano Profissional do Gestor Master.</span>
      		...
      		<div class="col-md-3 ftco-animate">
      			<p class="mb-0"><a target="_blank" href="https://gestormaster.top/faq?wpp&text=Gostaria%20de%20adquirir%20o%20plano%20de%201%20ano%20do%20gestor%20lite" class="btn btn-primary py-3 px-4">Contratar</a></p>
      		</div>
      	</div>
        <div class="row mb-5">
          <div class="col-md">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a target="_blank" href="https://gestormaster.top/termos/termos-gestor.pdf" class="py-2 d-block">Termos de uso</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Avenida Marte, 365 Contagem/MG CEP: 32241-395</span></li>
	                <li><a href="https://wa.me/553196352452"><span class="icon icon-whatsapp"></span><span class="text">+55 31 9635-2452</span></a></li>
	                <li><a href="tel:08000000270"><span class="icon icon-phone"></span><span class="text">+55 22 99854-2012</span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p> Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados 
            <!-- | Uma ferramenta de <a href="https://scriptmundo.com" target="_blank">Script Mundo</a></p> -->
            <!-- <p>CNPJ: 39.639.590/0001-32</p> -->
          </div>
        </div>
      </div>
    </footer>
