...
<head>
  <title>Gestor Master</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <meta name="keywords"
    content="chatbot whatsapp, Gestor Master, iptv gestor, gerenciamento de clientes,gerenciador de clientes, emissor de cobranças, whatsapi, cobrar clientes, automatico,emitir cobranças,controle financeiro,financeiro,planilha excel">
  <meta name="description" content="Gestor Master - Gerenciamento facilitado de clientes">
  ...
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/open-iconic-bootstrap.min.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/animate.css">

  <link rel="stylesheet" href="https://gestormaster.top/assets/css/owl.carousel.min.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/magnific-popup.css">

  <link rel="stylesheet" href="https://gestormaster.top/assets/css/aos.css">

  <link rel="stylesheet" href="https://gestormaster.top/assets/css/ionicons.min.css">

  <link rel="stylesheet" href="https://gestormaster.top/assets/css/bootstrap-datepicker.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/jquery.timepicker.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" />

  <link rel="stylesheet" href="https://gestormaster.top/assets/css/flaticon.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/icomoon.css">
  <link rel="stylesheet" href="https://gestormaster.top/assets/css/style.css">
  ...
  <meta property="og:url" content="https://gestormaster.top/">
  <meta property="og:title" content="">
  <meta property="og:image" content="https://gestormaster.top/img/logo.png">
  <meta property="og:description" content="Gestor Master - Gerenciamento facilitado de clientes">
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NTQZGRS" height="0" width="0"
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="">
        <img width="150" src="https://gestormaster.top/img/logo.png" />
      </a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="https://gestormaster.top/contato" class="nav-link">Contato</a></li>
          <li class="nav-item cta"><a href="https://gestormaster.top/login" class="nav-link"><span><i
                  style="font-size: 16px!important;" class="fa fa-user"></i> Login</span></a></li>
          <!--<li style="margin-left: 19px;" class="nav-item cta"><a href="tel:08000000270" class="nav-link"><span> <i style="font-size: 16px!important;" class="fa fa-phone"></i> +55 22 99854-2012</span></a></li>-->
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="container-fluid px-0">
      <div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
        <img class="one-third align-self-end order-md-last img-fluid"
          src="https://gestormaster.top/img/GESTOR-LITE-HOME.png" alt="">
        <div style="margin-bottom: 136px;" class="one-forth d-flex align-items-center ftco-animate js-fullheight">
          <div class="text mt-5">
            <p><a href="https://gestormaster.top/login/create" class="create_btn_home btn btn-primary px-4 py-3">Criar
                conta Grátis </a></p>
            <h1 class="mb-3"><span style="COLOR: #6927ff;font-family: 'montserrat';">Venha ser #gestor<y
                  style="<?= $styleColorMes[date('m')]; ?> font-family: 'montserrat';">master</y>
                <?= $smallTitle[date('m')]; ?>
              </span></h1>
            <p>
              Faça cobranças, capte e gerencie clientes, tudo em apenas um lugar. Economize seu tempo com a gente.
            </p>
            <!--<p><a href="https://gestormaster.top/login/create" class="btn btn-primary px-4 py-3">Criar conta Grátis</a></p>-->
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <div class="media-body pl-4">
              ...
              <p class="mb-0">Seu cliente recebe todo mês a cobrança que você definir em seu painel, você determina a
                data que será enviada..</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
              ...
              <p>Não se perca mais para ter seu controle financeiro, esqueça planilhas antigas de excel, aqui é tudo
                mais simples.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <div class="media-body pl-4">
              ...
              <p>Ofereça para seus clientes uma área do cliente exclusiva do seu negócio. Aumente sua credibilidade e
                ofereça uma ótima experiencia para seu cliente.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <div class="media-body pl-4">
              ...
              <p>Envie um link de pagamento para seu cliente ou divulgue sua campanha de marketing. Ofereça seus metodos
                de pagamentos personalizados em apenas um lugar.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <div class="media-body pl-4">
              ...
              <p>
                Nós te oferecemos uma semana grátis para testar nosso painel, assim lhe oferecendo uma enorme
                satisfação.
              </p>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
          <span class="subheading">Mais de
            <?= substr($cobrancas->num, 0, -3); ?> mil cobranças enviadas
          </span>
        </div>
      </div>
        ...
        <div class="col-md-10">
          <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
              <div class="block-18 text-center">
                <div class="text">
                  <strong class="number" data-number="<?= $cobrancas->num; ?>">
                    <?= substr($cobrancas->num, 0, -3) . '000'; ?>
                  </strong>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 py-5">
          <img src="https://gestormaster.top/assets/images/site2.svg" class="img-fluid" alt="">
          <div class="heading-section ftco-animate mt-5">
            <h2 class="mb-4">Integrado com gateways de pagamento</h2>
            <p>
              O painel Gestor Master, é integrado com as melhores gateways de pagamento. Possibilitando que seu cliente,
              através do seu link faça o pagamento de forma rápida segura e simples. Você é notificado na mesma hora que
              seu cliente efetuar o pagamento.
            </p>
          </div>
        </div>
        <div class="col-lg-6 py-5">
            ...
            <div class="col-md-6 ftco-animate">
              <div class="media block-6 services border text-center">
                ...
                <div class="mt-3 media-body media-body-2">
                  ...
                  <p>Adicione seu PicPay e receba pagamentos de seus clientes em uma das melhores carteiras digitais.
                  </p>
                </div>
              </div>
            </div>
  ...
  <section class="ftco-section ftco-no-pt ftc-no-pb">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 py-5">
          <img src="https://gestormaster.top/assets/images/chatbot.jpg" class="img-fluid" alt="">
        ...
        <div class="col-lg-6 py-5">
          ...
          <p>
            Com a Gestor Master, você terá um chatbot ligado 100% com sua base de clientes. <br />
            É possível interagir com seu cliente já sabendo de todos os dados dele até mesmo se ele já pagou ou não a
            última fatura. <br /><br />
            Podendo ter várias possibilidades de suporte agilizado, como por exemplo gerar uma segunda via através do
            chatbot. <br />
            Já funcionamos com <b>Whatsapp, Telegram, Messenger, Linkedin, Instagram, Twitter, Viber, Signal</b>
          </p>
          <div class="row text-center">
            <div class="col-md-3">
              <i style="font-size:20px;margin-right:10px;color:#6927ff!important;"
                class="fa fa-whatsapp"></i><br /><span style="color:#6927ff;">Em operação</span>
            </div>
            <div class="col-md-3">
              <i style="font-size:20px;margin-right:10px;color:#6927ff!important;"
                class="fa fa-instagram"></i><br /><span style="color:#6927ff;">Em operação</span>
            </div>
            <div class="col-md-3">
              <i style="font-size:20px;margin-right:10px;color:#6927ff!important;"
                class="fa fa-telegram"></i><br /><span style="color:#6927ff;">Em operação</span>
            </div>
            <div class="col-md-3">
              <i style="font-size:20px;margin-right:10px;color:#6927ff!important;"
                class="fa fa-facebook-square"></i><br /><span style="color:#6927ff;">Em operação</span>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 py-5">
          ...
          <p>
            Utilize seu whatsapp para enviar cobranças para seus clientes. Recupere clientes inadimplentes, envie
            campanhas no whatsapp. <br />
        ...
        <div class="col-lg-6 py-5">
          <img src="https://gestormaster.top/img/ApiGlite.png" width="80%" class="img-fluid" alt="">
          <div class="heading-section ftco-animate mt-5"></div>
        </div>
  ...
  <!-- <section class="ftco-section ftco-no-pt ftc-no-pb">
      <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 py-5">
            <img src="https://gestormaster.top/assets/images/notify-gestorlite.gif?v=2" width="80%" class="img-fluid" alt="">
            <div class="heading-section ftco-animate mt-5"></div>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 py-5">
          ...
          <p>
            A comunicação com cliente é o fator chave para um bom negócio e nós entendemos isso; é por isso que nós te
            entregamos a possibilidade interagir com seu cliente com a linguagem do seu negócio.
          </p>
        </div>

        <div class="col-lg-6 py-5">
          <img src="https://gestormaster.top/img/person-mobile-website-gesorlite.png" class="img-fluid" alt="">
          <div class="heading-section ftco-animate mt-5"></div>
        </div>
  ...
  <section class="ftco-section ftco-no-pt ftc-no-pb">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 py-5">
          <img src="https://gestormaster.top/img/link-pay-gestorlite.png" class="img-fluid" alt="">
          <div class="heading-section ftco-animate mt-5"> </div>
        </div>
        ...
        <div class="col-lg-6 py-5">
          ...
          <p>
            A tecnologia avança e nós também. A cada dia devemos nos reinventar e procurar soluções que atendam da
            melhor forma possível nossos clientes e clientes satisfeitos significa receita para seu estabelecimento.
          </p>
          <p>
            É por isso que a Gestor Master, oferece um link de pagamento para que você envie para clientes, por qualquer
            midia social. Um link que reune as melhoras formas de pagamentos que você definir em seu painel.
          </p>
        </div>
  ...
  <section class="ftco-section ftco-no-pt ftc-no-pb">
    <div class="container">
      <div class="row">
        ...
        <!-- <div class="col-lg-6 py-5">
              <img src="https://gestormaster.top/img/trafego-website-gestorlite.png" class="img-fluid" alt="">
              <div class="heading-section ftco-animate mt-5">
  ...
  <!-- <section class="ftco-section ftco-no-pt ftc-no-pb">
    <div class="container">
      <div class="row text-center">
        <div class="col-lg-12">
          <h3>
            Onde Gestor Master foi notícia
          </h3>
        </div>
        <div class="col-md-3 py-5">
          <img title="Terra" src="https://gestormaster.top/assets/images/news/terra.png" class="img-fluid" alt="">
        </div>
        <div class="col-md-3 py-5">
          <img title="Portal Comunique-se" src="https://gestormaster.top/assets/images/news/portal-comunique-se.png"
            class="img-fluid" alt="">
        </div>
        <div class="col-md-3 py-5">
          <img title="Estadão" src="https://gestormaster.top/assets/images/news/estadao.png" class="img-fluid" alt="">
        </div>
        <div class="col-md-3 py-5">
          <img title="Mundo do Marketing" src="https://gestormaster.top/assets/images/news/mk.png" class="img-fluid"
            alt="">
        </div>
  ...
  <!--		<div class="row text-center">-->
  <!--		    <div class="col-md-6">-->
  <!--		        <img width="100%" src="https://gestormaster.top/img/post-terra-500x500.png" />-->
  <!--		    </div>-->
  <!--		    <div class="col-md-6">-->
  <!--		        <img width="100%" src="https://gestormaster.top/img/mundo-marketing-post-500x500.png" />-->
  <!--		    </div>-->
  <!--		</div>-->
  <!--	</div>-->
  <!--</section>-->
            ...
            <div class="col-lg-4 col-md-6 ftco-animate">
              <div class="block-7">
                <div class="text-center">
                  ...
                  <span class="price"><sup>R$</sup> <span class="number">
                      <?= $plano->valor; ?><small class="per">/mês</small>
                    </span>
                    ...
                    <a href="https://gestormaster.top/login/create"
                      class="btn btn-primary d-block px-3 py-3 mb-4">Selecionar</a>
                </div>
              </div>
            </div>
      ...
      <div class="row justify-content-center mb-5 pb-3">
        ...
        <div class="row d-flex" style="width: 100%;">
          <div class="col-md-12" style="width: 100%;">
            <iframe style="width: 100%!important;border: 0px;overflow-y: hidden;overflow-x: hidden;"
              class="iframe_compare" id="iframe-compare" src="https://gestormaster.top/pages/compare.html?v=2"
              ...
              <div class="item">
               ...
               <a target="_blank" href="https://www.youtube.com/watch?v=DqVsmJvca-0" >
                ...
                <div class="testimony-wrap p-4 text-center">
                  <div class="user-img mb-4" style="background-image: url(https://gestormaster.top/assets/images/videoplay.png)">
        ...
        <div class="col-md-12 nav-link-wrap mb-5 pb-md-5 pb-sm-1 ftco-animate">
          <div class="nav ftco-animate nav-pills justify-content-center text-center" id="v-pills-tab" role="tablist"
            ...
            <a class="nav-link" id="v-pills-performance-tab" data-toggle="pill" href="#v-pills-performance" role="tab"
              aria-controls="v-pills-performance" aria-selected="false">Marketing</a>

            <a class="nav-link" id="v-pills-effect-tab" data-toggle="pill" href="#v-pills-effect" role="tab"
              aria-controls="v-pills-effect" aria-selected="false">Análise Financeira</a>
          </div>
        </div>
        <div class="col-md-12 align-items-center ftco-animate">
          ...
          <div class="tab-content ftco-animate" id="v-pills-tabContent">
            ...
            <!-- <div class="tab-pane fade show active" id="v-pills-nextgen" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                <div class="d-md-flex">
                  <div class="one-forth align-self-center">
                    <img src="https://gestormaster.top/assets/images/basedeconhecimento.svg" class="img-fluid" alt="">
                  </div>
                  <div class="one-half ml-md-5 align-self-center">
                    <h2 class="mb-4">Nossa Base de conhecimento</h2>
                    <p>Além de suporte remoto e especializado 24 horas por dia, você tem acesso ao nosso base de conhecimento, com tutoriais totalmente intuitivos com vídeos explicativos. Assim você não terá dúvidas para utilizar nosos painel.</p>
                    <p>E se sentir dúvidas, basta nos chamar no whatsapp, estaremos prontos para lhe atender.</p>
                    <p><a href="https://t.me/gestormaster/" target="_blank" class="btn btn-primary py-3">Ver base de conhecimento</a></p>
                  </div>
                </div>
              </div> -->
            ...
            <div class="tab-pane fade show active" id="v-pills-performance" role="tabpanel"
              ...
              <div class="d-md-flex">
                <div class="one-forth order-last align-self-center">
                  <img src="https://gestormaster.top/assets/images/undraw_visual_data_b1wx.svg" class="img-fluid"
                    alt="">
                </div>
                <div class="one-half order-first mr-md-5 align-self-center">
                  <h2 class="mb-4">Ferramentas de Marketings</h2>
                  <p>Nosso painel possui ferramentas de marketing para alavancar suas vendas online e sair na frente de
                    todo mundo. </p>
                  <p>Em breve teremos o plano com suporte especializado de marketing, aonde você, fala diretamente com
                    nosso especialista que irá lhe ajudar como atingir seus objetivos.</p>
                  <p><a href="https://gestormaster.top/login/create" class="btn btn-primary py-3">Criar conta grátis</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="v-pills-effect" role="tabpanel" aria-labelledby="v-pills-effect-tab">
              <div class="d-md-flex">
                <div class="one-forth align-self-center">
                  <img src="https://gestormaster.top/assets/images/undraw_business_plan_5i9d.svg" class="img-fluid"
                    alt="">
                </div>
                <div class="one-half ml-md-5 align-self-center">
                  <h2 class="mb-4">Análises financeiras</h2>
                  <p>Além do controle financeiro, nós iremos te mostrar suas métricas de ganhos para o próximos 3 mesês.
                  </p>
                  <p>Em seu painel financeiro nós calculamos sua média de ganhos analisamos e te informamos como está
                    seu rendimento e mostramos uma futura projeção de ganhos, com gráficos simples de entender.</p>
                  <p><a href="https://gestormaster.top/login/create" class="btn btn-primary py-3">Criar conta grátis</a>
                  </p>
                </div>
              </div>
  ...
  <!--          <a href="blog-single.html" class="block-20" style="background-image: url('https://gestormaster.top/assets/images/image_1.jpg');">-->
  <!--          </a>-->
  ...
  <!--          <a href="blog-single.html" class="block-20" style="background-image: url('https://gestormaster.top/assets/images/image_2.jpg');">-->
  <!--          </a>-->
  <!--          <div class="text d-flex py-4">-->
  <!--            <div class="meta mb-3">-->
  <!--              <div><a href="#">May 8, 2019</a></div>-->
  ...
  <!--          <a href="blog-single.html" class="block-20" style="background-image: url('https://gestormaster.top/assets/images/image_3.jpg');">-->
  <!--          </a>-->
  <!--          <div class="text d-flex py-4">-->
  <!--            <div class="meta mb-3">-->
  <!--              <div><a href="#">May 8, 2019</a></div>-->
      ...
      <div class="row mb-5 pb-5 align-items-center d-flex">
        <div class="col-md-6">
          <div class="heading-section heading-section-white ftco-animate">
            <span class="subheading">Pague menos pagando por um ano inteiro o plano Profissional do Gestor
              Master.</span>
        ...
        <div class="col-md-3 ftco-animate">
          <p class="mb-0"><a target="_blank"
              href="https://gestormaster.top/faq?wpp&text=Gostaria%20de%20adquirir%20o%20plano%20de%201%20ano%20do%20gestor%20lite"
              class="btn btn-primary py-3 px-4">Contratar</a></p>
        </div>
      </div>
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 bg-primary p-4">
            <h2 class="ftco-heading-2">Gestor Master</h2>
            <p>Tenha controle financeiro, emita cobranças automáticas através do whatsapp e email. A eficácia de um
              painel pensado em você.</p>
            ...
            <span style="color:#fff;font-size:20px;">#gestormaster</span>
          </div>
        </div>
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              ...
              <!-- <li><a target="_blank" href="https://t.me/gestormaster/" class="py-2 d-block">Base de conhecimento</a></li> -->
              <!-- <li><a target="_blank" href="https://gestormaster.top/termos/termos-gestor.pdf"
                  class="py-2 d-block">Termos de uso</a></li> -->
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="list-unstyled">
              <li><a href="https://gestormaster.top/" class="py-2 d-block">Home</a></li>
              <li><a href="https://gestormaster.top/login" class="py-2 d-block">Login</a></li>
              <li><a href="https://gestormaster.top/login/create" class="py-2 d-block">Criar Conta</a></li>
              <!-- <li><a href="https://gestormaster.top/faq" class="py-2 d-block">FAQ</a></li> -->
              <li><a href="https://gestormaster.top/contato" class="py-2 d-block">Contato</a></li>
            </ul>
          </div>
        </div>
        <!-- <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><a href="mailto:contact@gestormaster.top"><span class="icon icon-envelope"></span><span class="text">contact@gestormaster.top</span></a></li>
                </ul>
              </div>
            </div>
          </div> -->
  ...
  <script>
    setInterval(function () {
      $.post('https://gestormaster.top/b2c', function (data) {
        $("#valor_b2c").html('R$ ' + data);
      });
    }, 5000);
  </script>

  <script src="https://gestormaster.top/assets/js/jquery.min.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="https://gestormaster.top/assets/js/popper.min.js"></script>
  <script src="https://gestormaster.top/assets/js/bootstrap.min.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.easing.1.3.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.waypoints.min.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.stellar.min.js"></script>
  <script src="https://gestormaster.top/assets/js/owl.carousel.min.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.magnific-popup.min.js"></script>
  <script src="https://gestormaster.top/assets/js/aos.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.animateNumber.min.js"></script>
  <script src="https://gestormaster.top/assets/js/bootstrap-datepicker.js"></script>
  <script src="https://gestormaster.top/assets/js/jquery.timepicker.min.js"></script>
  <script src="https://gestormaster.top/assets/js/scrollax.min.js"></script>
  <script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="https://gestormaster.top/assets/js/google-map.js"></script>
  <script src="https://gestormaster.top/assets/js/main.js"></script>
