<?php 
 ...
 /*
  * Class integration Koffice V412
  */
 ...
 class KOfficeV4_12 {
      ...
      public function getAllPackegs($cms,$username,$password,$trial=0){
       ...
       $curl = curl_init();
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "http://api-panels.gestormaster.top/apps/kofficev4_12/?panel={$cms}&username={$username}&password={$password}&trial={$trial}&action=getPlanosTrial",
      ...
      public function gerateste($cms,$username,$password,$package){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "http://api-panels.gestormaster.top/apps/kofficev4_12/?panel={$cms}&username={$username}&password={$password}&package_id={$package}&action=createTeste",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
