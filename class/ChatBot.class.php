                ...
                if($reply->sender_info != 'false'){
                   ...
                   if($reply->sender_info == "senderNotas"){
                       if($cliente){
                        ...
                        //    $msgToReply = "Notas erro do JayVi.";
                       }
                   }else if($reply->sender_info == "senderEmail"){
                       if($cliente){
                           $msgToReply = 'Seu email é: '.$cliente->email;
                       }else{
                        //    $msgToReply = "Email erro do JayVi.";
                           $msgToReply = " id: $chatbot->id_user, num: $num";
                        }
                    }else if($reply->sender_info == "senderSenha"){
                        if($cliente){
                            $msgToReply = 'Sua senha é: '.$cliente->senha;
                            //  $msgToReply = "Senha erro do JayVi.";
                        }else{
                            $msgToReply = "Desculpe, você não está registrado em nosso sistema.";
                            // $msgToReply = "Não registrado erro do JayVi.";
                        }
                        ...
                        if($cliente){
                            $msgToReply = 'Olá sua data de vencimento é: '.$cliente->vencimento;
                             ...
                             $msgToReply = "Desculpe, você não está registrado em nosso sistema.";
                            // $msgToReply = "Data de vencimento erro do JayVi.";
                       }
                          ...
                          if(count($fetch)>0){
                            ...
                            $response = file_get_contents("https://gestormaster.top/painel/api.php?chave={$painelTeste->chave}&bot=1&package={$pacote}&email={$email}&nome={$nome}&whatsapp={$num}&gerateste");
