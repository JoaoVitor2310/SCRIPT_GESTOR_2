...
class Gateways extends Conn
{
  ...
  public function pagamento_mp($client_id, $client_secret, $ref, $nome, $valor, $url)
  {
    ...
    $preference_data = array(
      ...
      "back_urls" => array(
        "success" => 'https://gestormaster.top/painel/payment_notification/' . $refUrl . '/mercadopago',
        "failure" => 'https://gestormaster.top/painel/payment_notification/' . $refUrl . '/mercadopago',
        "pending" => 'https://gestormaster.top/painel/payment_notification/' . $refUrl . '/mercadopago'

      ),
      "notification_url" => 'https://gestormaster.top/painel/payment_notification/' . $refUrl . '/mercadopago',
    ...
    return $link;
      ...
      // Ocorreu um erro durante a criação da preferência
      // Você pode lidar com o erro aqui, como exibir uma mensagem de erro ou fazer alguma ação específica

      return $e->getMessage();
      // echo 'Erro ao criar preferência: ' . $e->getMessage();
      // Você também pode lançar a exceção novamente para que ela seja tratada em outro lugar do código, se necessário
      // throw $e;
    }
