<?php
  ...
  class MercadoPago extends Conn{
      ...
      private $client_id     = "3338165631581935";
      private $client_secret = "f4K9J0sSbSKpgLIjZcwHRxu4ejG7XK6c";
      private $acces_token   = "APP_USR-3338165631581935-092610-04654d3e679ccf0fc6002142046aed55-134646243";

      private $url_retorno = "https://gestormaster.top/pay?return";
      ...
      public function tarifas_mp($tipo_pay,$valor){
       ...
       public function paymentAf($afiliado,$fatura,$ref,$plano,$access_tokenMP){
        ...
        if($valor_af){
                ...
                $item->picture_url = 'https://gestormaster.top/img/logo.png';
                $item->quantity = 1;
                ...
                $preference->back_urls = array(
                   "success" => 'https://gestormaster.top/painel/pagamentos',
                   "failure" => 'https://gestormaster.top/painel/pagamentos',
                   "pending" => 'https://gestormaster.top/painel/pagamentos'
                );
      ...
      public function payment($ref, $nome , $valor){
          ...
          $items = array(
              array(
                ...
                "title" => $nome,
                "currency_id" => "BRL",
                "picture_url" => "https://gestormaster.top/img/logo.png",
                "description" => $nome.' - Gestor Master',
                "quantity" => 1,
                "unit_price" => $valor
              )
          );
...
";
                ...
                file_get_contents("http://xdroid.net/api/message?k=k-1e7e607d2708&t=".urlencode('Um nova venda - Gestor Master')."&c=".urlencode('Venda de R$ '.$fatura->valor.', para o plano: '.$plano->nome)."&u=https://gestormaster.top");
                file_get_contents("http://xdroid.net/api/message?k=k-01ad8c7dae47&t=".urlencode('Um nova venda - Gestor Master')."&c=".urlencode('Venda de R$ '.$fatura->valor.', para o plano: '.$plano->nome)."&u=https://gestormaster.top");
                ...
                //          $img = "https://gestormaster.top/template_mail/template_1/img/heart.png";
                ...
                //          $init = file_get_contents('http://api-zapi.gestormaster:3000/send?device=cb0e11a07208f0067a37019750&number='.$phone.'&text='.urlencode($texto));
                //      }
