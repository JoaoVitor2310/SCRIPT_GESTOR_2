<?php 
  ...
  if(isset($_FILES) && isset($_POST['meio_pay_idFat'])){
          ...
          if($comp){
              ...
              $text = "Olá! Um de seus clientes, enviou um comprovante pelo sistema Gestor Master.\nReferente a fatura: #".$_POST['meio_pay_idFat']."\nAcesse Seu painel e confira.\n\nOu clique no link abaixo: https://gestormaster.top/comprovantes/".explode('|',$comp)[1];
              ...
              $whatsapi_class->fila($phone,$text,$adm->id,'ZAPI','ZAPI','0000','0000',"comprovante_recebido");
