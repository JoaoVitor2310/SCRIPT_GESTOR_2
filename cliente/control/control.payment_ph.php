      ...
      if(isset($_REQUEST['dados'])){
          ...
          if($planouser->gateways == 1){
              ...
              if($dados->metodo = "PH" || $dados->metodo = "ph" && $ph_credenciais){
                  ...
                  $payment = $gateways->pagamento_ph($ph_credenciais->token,$ph_credenciais->apikey,$ref,$dados->plano,$valor,"https://gestormaster.top/painel/payment_notification/'.$refUrl.'/paghiper",$dados_cliente,$dados->cpf);
