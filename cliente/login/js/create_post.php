            ...
            if ($plano) {
                ...
                if ($mail_existe) {
                    ...
                    if ($inser != '0') {
                        ...
                        $link = "https://cliente.gestormaster.top/{$areaCli->slug_area}?token={$token}";
                        
                        $ar1 = array('{nome_cliente}', '{senha}', '{link_panel}');
                        $ar2 = array($dados->nome, $dados->senha, "https://cliente.gestormaster.top/{$areaCli->slug_area}");
                        ...
                        if ($device) {
                            ...
                            //Msg do vendedor para o cliente
