  ...
  ?>
          				...
          				<div style="padding:30px;" class="row">
          				    ...
          				    <div class="col-md-6">
          				        ...
          				        <?php if($qtd_indicacoes->qtd >= $conf_indicacao->qtd){ ?>
          				         <del class="text-info link_ind"  style="cursor:pointer;" >https://gestormaster.top/gmaster/ind/<?= str_replace("=","",base64_encode($_SESSION['SESSION_CLIENTE']['id'])); ?></del>
          				        <?php }else{ ?>
          				         <span onclick="copy_link();" class="text-info link_ind"  style="cursor:pointer;" >https://gestormaster.top/gmaster/ind/<?= str_replace("=","",base64_encode($_SESSION['SESSION_CLIENTE']['id'])); ?></span>
          				        <?php } ?>
          				    </div>
          				</div>
          				<?php
    ...
    <input type="text" id="input_link" value="https://gestormaster.top/gmaster/ind/<?= str_replace("=","",base64_encode($_SESSION['SESSION_CLIENTE']['id'])); ?>" style="left: -40008px!important;z-index: -540;float: left;position: absolute;" />
    <script>
        function copy_link(){
