 ...
 function save_my_profile(){
   ...
   $.post('https://cliente.gestormaster.top/control/control.edite_dados_cliente.php',{dados:dados},function(data){
 ...
 function payment(fat,ref,metodo,valor,plano){
    ...
    if(metodo == "MP"){
     ...
     var urlEndpoint = "";
        ...
        if(metodo == "MP"){
            urlEndpoint = "https://cliente.gestormaster.top/control/control.payment_mp.php";
        }else if(metodo == "PH"){
            urlEndpoint = "https://cliente.gestormaster.top/control/control.payment_ph.php";
        }
