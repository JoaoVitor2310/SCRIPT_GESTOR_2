  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Atualizazções Gestor Master</h1>
    ...
    <div class="card-body" >
      <div class="table-responsive">
        ...
        ?>
            ...
            <textarea style="display:none;" id="texto_att_<?= $att->id; ?>" ><?= $att->texto; ?></textarea>

            <tr>
              <td><?= $att->id; ?></td>
              <td><?= $att->nome; ?></td>
              <td><span class="text-info" style="cursor:pointer;" onclick="view_texto(<?= $att->id; ?>);" ><?= substr($att->texto,0,50).'...'; ?></span></td>
              <td><?= $att->data; ?></td>
              <td>

                  <button onclick="remove_att(<?= $att->id; ?>);" id="btn_remove_att_<?= $att->id; ?>" class="btn btn-sm btn-danger" title="Remover">
...
<!-- Modal -->
<div class="modal fade" id="modal_texto_att" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="modal_add_att" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body" id="" >
            ...
            <div class="form-group">
                <textarea class="form-control" id="texto_att" placeholder="Informe as novidades" rows="5" ></textarea>
            </div>
