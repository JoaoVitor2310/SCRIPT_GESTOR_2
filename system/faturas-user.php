...
$num_flyers   = $flyers_class->count_flyer_prossing();
 ...
 if(!isset($_GET['user'])){
     echo '<script>location.href="https://gestormaster.top/system/index.php?page=home";</script>';
     die;
 }
          ...
          <div class="table-responsive">
            ...
            ?>
                ...
                <tr>
                  ...
                  <td><?php if($fatura->comprovante != '0'){ echo '<a target="_blank" href="https://gestormaster.top/comprovantes/'.$fatura->comprovante.'" >Ver Comp <i class="fa fa-file" ></i></a>'; } ?></td>
                  <td>
