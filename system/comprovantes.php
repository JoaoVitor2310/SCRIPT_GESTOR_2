        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2"> <i class="fa fa-upload"></i> Comprovantes
                        <?= $num_comprovantes; ?>
                    </h1>
                </div>
                                    ...
                                    <?php if ($num_comprovantes > 0) {
                                        ...
                                        while ($comprovante = $comprovantes->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($fatura->comprovante != '0') {
                                                        echo '<a target="_blank" href="https://gestormaster.top/comprovantes/' . $fatura->comprovante . '" >' . $fatura->comprovante . ' <i class="fa fa-external-link" ></i></a>';
                                                    } ?>
                                                </td>
                                                <td>
                                                    <?= $fatura->id_user; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="aceita_comp(<?= $fatura->id; ?>,<?= $fatura->id_user; ?>);"
                                                        id="btn_aceita_comp<?= $fatura->id; ?>" class="btn btn-sm btn-success"
                                                        title="Aceitar">
                                                        <i class="fa fa-check"></i>
                                                    </button>
                                                    <button
                                                        onclick="rejeita_comp(<?= $fatura->id; ?>,<?= $fatura->id_user; ?>);"
                                                        id="btn_rejeita_comp<?= $fatura->id; ?>" class="btn btn-sm btn-danger"
                                                        title="Rejeitar">
