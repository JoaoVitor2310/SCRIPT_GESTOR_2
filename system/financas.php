...
if(isset($_SESSION['SUB_ACCESS'])){
 ...
 if(!isset($_SESSION['ADMIN_LOGADO'])){
     ...
     $url = "http://".$dominio."/cont_user.php";
  ...
  <div class="row">
    ...
    <div class="row" style="margin-top:10px;" >
         <div class="col-md-3">
            <div style="padding:10px;" class="card">
                <h4><i class="text-secondary fa fa-dollar" ></i> R$ <?= $financeiro_class->convertMoney(2,($financeiro_class->convertMoney(1,$valor_mes_atual[0])-$financeiro_class->convertMoney(1,$valor_mes_atual[1]))); ?></h4>
        ...
        <div class="col-md-3">
            <div style="padding:10px;" class="card">
                ...
                <small style="font-size:12px;" >Valor Não Tarifado | Mercado Pago | PIX</small>
            </div>
        </div>
         <div class="col-md-3">
            <div style="padding:10px;" class="card">
    ...
    <hr >
        ...
        <div style="margin-top:5px;" class="col-md-4">
         ...
         <div style="margin-top:5px;" class="col-md-4">
            <div style="padding:10px;" class="card">
                <h4 class="<?php if($get_dados_users->porcentagem < 10){ echo 'text-danger'; } ?><?php if($get_dados_users->porcentagem > 10 && $get_dados_users->porcentagem < 50){ echo 'text-warning'; } ?><?php if($get_dados_users->porcentagem > 50 && $get_dados_users->porcentagem < 100){ echo 'text-success'; } ?>" ><i class="<?php if($get_dados_users->porcentagem < 10){ echo 'text-danger'; } ?><?php if($get_dados_users->porcentagem > 10 && $get_dados_users->porcentagem < 50){ echo 'text-warning'; } ?><?php if($get_dados_users->porcentagem > 50 && $get_dados_users->porcentagem < 100){ echo 'text-success'; } ?> fa fa-percent" ></i> <?= $get_dados_users->porcentagem; ?></h4>
                <small>Isso representa <b><?= $get_dados_users->porcentagem; ?> %</b> de todos os clientes</small>
            </div>
        </div>
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="btn-gorup">
            <button onclick="add_novimentacao();" class="btn btn-info btn-sm" > <i class="fa fa-plus" ></i> Adicionar movimentação</button>
        </div>
      </div>
...
<div class="modal fade" id="modal_add_mov" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <script src="https://gestormaster.top/painel/js/jquery.maskMoney.js" ></script>
