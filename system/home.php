<?php
 ...
 $vendas_hj_fetch = $financeiro_class->vendas_day_admin(date('d/m/Y')) ? $financeiro_class->vendas_day_admin(date('d/m/Y')) : array();
          ...
          <div class="form-group">
              ...
              <select onchange="export_type();" id="export_type" class="form-control form-control-sm" >
                    ...
                    <optgroup label="Marketing Mail">
                        <option value="&type=vencidos&patrao&mail" >Clientes Patrão vencidos Marketing Mail</option>
                              ...
                              <div style="margin-bottom:10px;" class="col-md-12">
                                   <div class="card">
                                      ...
                                      <div class="card-body">
                                          <div class="row">
                                              <div class="col-md-6">
                                                  <h3>R$ <?= $financeiro_class->convertMoney(2,$value_vendas_hj['valor']); ?></h3>
                                              </div>
                                              <div class="col-md-6">
                                   ...
                                   <div class="card">
                                      ...
                                      <div class="card-body">
                                       <table class="table table-sm">
                                          ...
                                          <tbody>
                                           <?php $i=1; foreach($vendas_hj_fetch as $key => $value){ ?>
                                             <tr>
...
<!-- Modal edita user -->
<div class="modal fade" id="edita_user_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="form-group" >
             <input type="text" class="form-control" placeholder="Telefone" value="" name="telefone" id="telefone" />
         </div>
         <div class="form-group" >
             <input type="text" class="form-control" placeholder="Senha" value="" name="senha" id="senha" />
         </div>
         <div class="form-group" >
             <input type="text" class="form-control" placeholder="Vencimento" value="" name="vencimento" id="vencimento" />
         </div>
         <div class="form-group" >
