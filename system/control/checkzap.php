       ...
       $api =  $wpp_class->verific_device_situ($get->id);
         ...
         if($api){
             ...
             if($api->api == "ZAPI"){
                  ...
                  curl_setopt($ch, CURLOPT_URL, "http://api-zapi.gestormaster:3000/qrcode?device={$device}");
                 ...
                 echo json_encode(['erro' => false, 'msg' => "O cliente {$get->nome}, usa a API da Gestor Master. Está conectada", 'date' => date('d/m/Y H:i:s')]);
                 die;
             }
